...
- 🎯 Entry points to execute your program using `python -m <flask_project>` or `$ flask_project` with basic CLI argument parsing.
...
---
# flask_project Flask Application

Awesome flask_project created by deegok11
...
```bash
git clone https://github.com/deegok11/flask_project flask_project
cd flask_project
make install
```
...
```bash
flask_project create-db   # run once
flask_project populate-db  # run once (optional)
flask_project add-user -u admin -p 1234  # ads a user
flask_project run
```
